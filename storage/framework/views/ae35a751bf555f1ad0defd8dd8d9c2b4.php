...
<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            <?php echo e(__('Informações da Conta')); ?>

        </h2>

        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__("Atualize as informações do perfil da sua conta e o endereço de e-mail.")); ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if(auth()->user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! auth()->user()->hasVerifiedEmail()): ?>
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        <?php echo e(__('Seu endereço de email não está verificado.')); ?>
...
</section><?php /**PATH D:\repositoriosLsv\laravel12-livewire-crud\resources\views\livewire/profile/update-profile-information-form.blade.php ENDPATH**/ ?>