...
<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Uma vez que sua conta for deletada, todos os seus recursos e dados serão permanentemente removidos. Por favor, digite sua senha para confirmar que deseja deletar sua conta definitivamente.')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '','x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-user-deletion\')']); ?><?php echo e(__('Excluir a Conta')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['wire:model' => 'password','id' => 'password','name' => 'password','type' => 'password','class' => 'mt-1 block w-3/4','placeholder' => ''.e(__('Senha')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'password','id' => 'password','name' => 'password','type' => 'password','class' => 'mt-1 block w-3/4','placeholder' => ''.e(__('Senha')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
</section><?php /**PATH D:\repositoriosLsv\laravel12-livewire-crud\resources\views\livewire/profile/delete-user-form.blade.php ENDPATH**/ ?>